...
class PostDetailView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated and self.post_instance.user_can_like(request.user):
            can_like = True
        return render(request, 'home/detail.html', {'post': self.post_instance, 'comments': comments, 'form': form, 'reply_form': self.form_class_reply(), 'can_like': can_like})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_comment.save()
            messages.success(request, 'your comment submitted is successfully', 'success')
